...
/**
 * src/Exceptions/ControllerNotFoundException.php
 ...
 * @version   1.0.0
 * @since     2025-10-02
 * @link      https://github.com/rxcod9/php-swoole-crud-microservice/blob/main/src/Exceptions/ControllerNotFoundException.php
 */
