...
final class RedisPool
{
     ...
     */
    public function __construct(private array $conf, private readonly int $min = 5, private readonly int $max = 200, private readonly float $idleBuffer = 0.025, private readonly float $margin = 0.025)
    {
